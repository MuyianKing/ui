...
// 设置标签
function setTags(tag_toute: any) {
...
.main-body-wrapper .bottom-wrapper {
  width: 100%;
  display: flex;
...
.main-body-wrapper .bottom-wrapper .content-box {
  background: #eee;
  flex: 1;
  min-width: 0;
  min-height: 0;
...
.main-body-wrapper .bottom-wrapper .content-box .tags-item {
  margin: 10px 0;
}
</style>
